                                                ...
                                                <div className="p-5">
                                                    ...
                                                    <hr className="my-4"/>
                                                        ...
                                                        <div className="mb-3">
                                                            ...
                                                            <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="Nhập Mã sản Phẩm"/>
                                                        </div>
                                                        <div className="mb-3">
                                                    ...
                                                    <hr className="my-4"/>
                                                        <button type="button" className="btn btn-outline-secondary">Thêm Sản Phẩm</button>
