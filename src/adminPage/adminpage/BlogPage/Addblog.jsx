                                                ...
                                                <div class="col-lg-12">
                                                    <div class="p-5">
                                                        <div class="d-flex justify-content-between align-items-center mb-5">
                                                            <h1 class="fw-bold mb-0 text-black"> Thêm Blog</h1>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1" class="form-label tille_content">Mã Blog</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                        ...
                                                        <hr class="my-4" />
                                                        <button type="button" class="btn btn-outline-secondary">Thêm Blog</button>
